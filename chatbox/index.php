...
"title"=>"ZKIZ Chat",
//第一個到聊天室的歡迎
"firstone"=>"<span style='color:#16a5e9;'>新的一期開始了!</span>",
//當信息有禁止內容時顯示
...
暱稱:<input type=text class="inputtext bg" size="12" id='chat_user' value='<?php echo $islog?"未登入":$gUsername; ?>' readonly />
