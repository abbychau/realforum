...
<div class="mainborder">
	...
	<?php if($_GET['showarchive'] == 'true'){ ?>

		<?php $initNum = $startRow_getReply; ?>

		<?php foreach($getReply as $row_getReply) { ?>
			<? ++$initNum ?>
			...
			<div class="ui-widget-content clear" style='padding:15px;'>
				...
				<div style="width:100%; font-size:16px;">
					<? if ($initNum == 1) { ?>
						...
						<div class="clear"></div>
						<fb:like show_faces="true" width="450" href="<?= $g_domain; ?>/thread.php?tid=<?= $gTid; ?>"></fb:like>
						<div style='padding:10px 0'>

							<?= $bbcode->Parse($row_getReply['content']); ?></div>
					<? } ?>
					<div style='font-size:12px'>
						...
						<?php if ($row_getReply['alias'] != "") {
							echo "(" . $row_getReply['alias'] . ")";
						} ?>
					...
					<? if ($initNum == 1) { ?>
						...
						<script type="text/javascript" src="http://s7.addthis.com/js/250/addthis_widget.js#username=abbychau"></script><!-- AddThis Button END -->
						<div class='left'>
							<a name="fb_share" type="button_count" href="http://www.facebook.com/sharer.php">分享</a>
	...
	<div id="adsb4post" style='display:none'>
		...
		<?php if ($noguest != true || $isLog == true) { ?>
