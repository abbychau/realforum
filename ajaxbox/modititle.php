<?php
	...
	if(modRank($fid)==0 && $gUserGroup <= 7 && $isauthor == 0){die("Access Denied!");}
	//
	...
	if ((isset($_POST["title"])) && ($_POST["title"] != "")) {
		$page = safe($_POST['page']);
		$title = safe($_POST['title']);
		$subtitle = safe($_POST['subtitle']);
		dbQuery("UPDATE zf_contentpages SET title = '$title', subtitle = '$subtitle' WHERE id=$tid");
