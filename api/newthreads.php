...
<rss version='2.0'>
  <channel>
	...
	$query_getConList = "SELECT a.fid, a.fellowid, a.username, a.datetime, commentnum, substr(a.title,1,30) as title, b.views, b.isshow, b.isdigest, b.id FROM zf_view_thread a, zf_contentpages b WHERE isfirstpost = 1 AND a.fellowid = b.id ORDER BY id DESC LIMIT 10";
