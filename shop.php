...
<style>
	...
	.item_grid {
		width: 34px;
		height: 34px;
		background-image: url(http://cdn.topost.me/real_css_lib-rev1/34x34icons180709.png);
	}
	...
	</style <div class="ui-widget-content pd5"style="margin-bottom:5px"><h3><?= $htmltitle ?></h3><table cellpadding="5"><tr><td><ol id="selectable"><li class="ui-widget-content item_grid"item_id="1"sprite_x="0"sprite_y="14"desc='透視鏡'></li></ol></td><td valign='top'><div class='ui-widget-content pd5'><form method='post'id='form1'><h4 id='item_title'></h4><div id='current_item_icon item_grid'class='left'></div><div class='left pd5'id='description'></div><div class='clear'></div><input type='hidden'name='code'id='hidden_code'value="none"/><a id='submit_btn'class='button hide2'onclick="$('#form1').submit();">確定買入</a></form><? if ($success_message != "") { ?><fieldset><?= $success_message; ?></fieldset><? } ?><br /></div><div class='ui-widget-content pd5'style='margin-top:3px'><div class='left eq_icon'id='eq1_icon'></div><div class='left eq_icon'id='eq2_icon'></div><div class='clear'></div></div></td></tr></table></div><?
